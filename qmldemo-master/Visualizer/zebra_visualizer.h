#ifndef ZEBRA_VISUALIZER_H
#define ZEBRA_VISUALIZER_H
...
class PSurfZebraVisualizer : public GMlib::PSurfVisualizer<T,n> {
    GM_VISUALIZER(PSurfZebraVisualizer)
public:
    PSurfZebraVisualizer();
    PSurfZebraVisualizer( GMlib::DMatrix<GMlib::DMatrix<GMlib::Vector<T,n>>>& p, GMlib::DMatrix<GMlib::Vector<float,n>>& no );
    PSurfZebraVisualizer( const PSurfZebraVisualizer<T,n>& copy );
...
template <typename T, int n>
inline
    PSurfZebraVisualizer<T,n>::PSurfZebraVisualizer()
...
template <typename T, int n>
inline
    PSurfZebraVisualizer<T,n>::PSurfZebraVisualizer(GMlib::DMatrix<GMlib::DMatrix<GMlib::Vector<T,n>>>& p, GMlib::DMatrix<GMlib::Vector<float,n>>& no)
...
template <typename T, int n>
inline
    PSurfZebraVisualizer<T,n>::PSurfZebraVisualizer(const PSurfZebraVisualizer<T,n>& copy)
...
template <typename T, int n>
void PSurfZebraVisualizer<T,n>::render( const GMlib::SceneObject* obj, const GMlib::DefaultRenderer* renderer ) const {
...
template <typename T, int n>
void PSurfZebraVisualizer<T,n>::renderGeometry( const GMlib::SceneObject* obj, const GMlib::Renderer* renderer, const GMlib::Color& color ) const {
...
template <typename T, int n>
void PSurfZebraVisualizer<T,n>::update() {

    PSurfZebraVisualizer<T,n>::fillStandardVBO( _vbo, *(this->_p) );
    PSurfZebraVisualizer<T,n>::fillTriangleStripIBO( _ibo, this->_p->getDim1(), this->_p->getDim2(), _no_strips, _no_strip_indices, _strip_size );
    PSurfZebraVisualizer<T,n>::fillNMap( _nmap, *(this->_n), this->_closed[0], this->_closed[1] );
}
...
template <typename T, int n>
inline
    void PSurfZebraVisualizer<T,n>::draw() const {
...
template<typename T,int n>
void PSurfZebraVisualizer<T,n>::initShaderProgram() {
    ...
    std::ifstream file("../../qmldemo-master/Visualizer/zebra_visualizer_string.txt");
    if (!file.is_open()) {
...
template <typename T, int n>
inline
    void PSurfZebraVisualizer<T,n>::_init() {
...
// #include "zebra_visualizer.c"
#endif // ZEBRA_VISUALIZER_H
